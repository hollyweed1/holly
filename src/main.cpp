...
const string strMessageMagic = "hollyweed Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 10) // HOLLYWEED Be stoned
    {
        nSubsidy = 5000000 * COIN;
    }
    else if(pindexBest->nHeight < 900000) // No WEED
    {
        nSubsidy = 0 * COIN;
    }
...
// hollyweed: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "hollyweed", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "HOLLY";
        CTransaction txNew;
        txNew.nTime = 1485909241;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x9b28f9831f850e8617fa94558aecdc1e73eb65423ed5fd368fb2c5856da4f964"));
        block.print();
